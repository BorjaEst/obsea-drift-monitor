...
[![Build Status](https://jenkins.services.ai4os.eu/buildStatus/icon?job=AI4OS-hub/obsea-drift-monitor/main)](https://jenkins.services.ai4os.eu/job/AI4OS-hub/job/obsea-drift-monitor/job/main)

Drift detector and monitor for obsea data adquisition.
...
```bash
git clone https://github.com/ai4os-hub/obsea-drift-monitor
cd obsea-drift-monitor
pip install -e .
...
The folder `obsea_drift_monitor` is designed to contain the source
...
The only requirement is that the folder `obsea_drift_monitor` contains
...
another file. See the [README.md](./obsea_drift_monitor/README.md)
in the `obsea_drift_monitor` folder for more information.
...
the [README.md](./obsea_drift_monitor/README.md)
