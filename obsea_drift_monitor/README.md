...
```bash
$ python -m obsea_drift_monitor.make_dataset {your_arguments}
$ python -m obsea_drift_monitor.make_model {your_arguments}
$ python -m obsea_drift_monitor.compare_models {your_arguments}
```
...
```bash
$ python -m obsea_drift_monitor.dataset.make_dataset {your_arguments}
$ python -m obsea_drift_monitor.models.make_model {your_arguments}
$ python -m obsea_drift_monitor.visualization.compare_models {your_arguments}
```
